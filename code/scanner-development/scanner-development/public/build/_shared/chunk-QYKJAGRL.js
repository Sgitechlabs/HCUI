...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\components\\\\Table.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701621914980.9495";
}
var Table = ({
  column,
  data
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "p-2", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("table", { className: "w-full", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("thead", { className: "w-full bg-gray-200 p-4", children: table.getHeaderGroups()?.map((headerGroup) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("tr", { className: "border-gray-400 uppercase border", children: headerGroup.headers?.map((header) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("th", { className: "border py-4", children: header.isPlaceholder ? null : flexRender(header.column.columnDef.header, header.getContext()) }, header.id, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("tbody", { className: "w-full text-center items-center bg-white  uppercase", children: table.getRowModel().rows?.map((row) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("tr", { className: "border", children: row.getVisibleCells()?.map((cell) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("td", { className: "border py-2 text-sm", children: flexRender(cell.column.columnDef.cell, cell.getContext()) }, cell.id, false, {
      fileName: "app/components/Table.tsx",
      lineNumber: 44,
      columnNumber: 51
    }, this)) }, row.id, false, {
...
_s(Table, "+qfJc9U8evODZQ8bBg9G2KVouAc=", false, function() {
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701621581795.447";
}
...
var providerHelper = createColumnHelper();
var ProviderColumn = [
...
var usersHelper = createColumnHelper();
var UsersColumn = [
...
@tanstack/react-table/build/lib/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=/build/_shared/chunk-QYKJAGRL.js.map
