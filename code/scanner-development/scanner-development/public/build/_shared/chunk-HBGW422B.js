...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\components\\\\Form\\\\Input.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701614497236.6138";
}
var Input = ({
  name,
  placeholder,
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-col gap-2 relative", children: [
    ...
    error[name] && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "m-auto ml-0 absolute top-16 text-xs pt-2 text-red-600 text-left justify-start", "data-error": "data-error", children: error[name]?.message }, void 0, false, {
      fileName: "app/components/Form/Input.tsx",
      lineNumber: 39,
      columnNumber: 20
    }, this)
...
var ObjectSchema = class extends Schema {
  ...
  pick(keys) {
    ...
    return this.setFields(picked, this._excludedEdges.filter(([a2, b]) => keys.includes(a2) && keys.includes(b)));
  }
  omit(keys) {
    const remaining = [];
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701579960232.796";
}
var codeVersionSchema = create$3().shape({
  hc: create$6().required("HC is required").min(10, "HC must be 10 character long").max(10, "HC must be 10 character long"),
  versionCode: create$6().required("Version code is Required").min(2, "Version code must be 2 character long").max(2, "Version code must be 2 character long")
});
var createOrganistionSchema = create$3().shape({
  organisation: create$6().required("HC is required"),
  phone: create$6().required("Version code is Required"),
  mobile: create$6().required("Version code is Required"),
  email: create$6().required("Version code is Required"),
  street1: create$6().required("Version code is Required")
...
//# sourceMappingURL=/build/_shared/chunk-HBGW422B.js.map
