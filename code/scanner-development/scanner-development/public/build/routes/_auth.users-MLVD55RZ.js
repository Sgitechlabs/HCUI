...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\routes\\\\_auth.users.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701579960231.2354";
}
...
//# sourceMappingURL=/build/routes/_auth.users-MLVD55RZ.js.map
